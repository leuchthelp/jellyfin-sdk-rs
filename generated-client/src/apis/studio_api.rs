...
pub trait StudioApi: Send + Sync {
    ...
    ///
    /// 
    async fn get_studio(&self,  params: GetStudioParams ) -> Result<models::BaseItemDto, Error<GetStudioError>>;

    /// GET /Studios
    ///
    /// 
    async fn get_studios(&self,  params: GetStudiosParams ) -> Result<models::BaseItemDtoQueryResult, Error<GetStudiosError>>;
}
...
/// struct for passing parameters to the method [`StudioApi::get_studio`]
#[derive(Clone, Debug)]
...
/// struct for passing parameters to the method [`StudioApi::get_studios`]
#[derive(Clone, Debug)]
...
#[async_trait]
impl StudioApi for StudioApiClient {
    async fn get_studio(&self,  params: GetStudioParams ) -> Result<models::BaseItemDto, Error<GetStudioError>> {
...
/// struct for typed errors of method [`StudioApi::get_studio`]
...
/// struct for typed errors of method [`StudioApi::get_studios`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
