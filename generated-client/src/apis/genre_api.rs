...
pub async fn get_genre(configuration: &configuration::Configuration, genre_name: &str, user_id: Option<&str>) -> Result<models::BaseItemDto, Error<GetGenreError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_genre_name = genre_name;
    let p_query_user_id = user_id;

    let uri_str = format!("{}/Genres/{genreName}", configuration.base_path, genreName=crate::apis::urlencode(p_path_genre_name));
