...
------------- | ------------- | -------------
[**get_grouping_options**](UserViewApi.md#get_grouping_options) | **GET** /UserViews/GroupingOptions | Get user view grouping options.
[**get_user_views**](UserViewApi.md#get_user_views) | **GET** /UserViews | Get user views.
...
**preset_views** | Option<[**Vec<models::CollectionType>**](Models__CollectionType.md)> | Preset views. |  |
