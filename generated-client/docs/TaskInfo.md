...
**state** | Option<[**models::TaskState**](TaskState.md)> | Gets or sets the state of the task. | [optional]
**current_progress_percentage** | Option<**f64**> | Gets or sets the progress. | [optional]
**id** | Option<**String**> | Gets or sets the id. | [optional]
**last_execution_result** | Option<[**models::TaskResult**](TaskResult.md)> | Gets or sets the last execution result. | [optional]
