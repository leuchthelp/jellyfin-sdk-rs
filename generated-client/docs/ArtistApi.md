...
------------- | ------------- | -------------
[**get_album_artists**](ArtistApi.md#get_album_artists) | **GET** /Artists/AlbumArtists | Gets all album artists from a given item, folder, or the entire library.
[**get_artist_by_name**](ArtistApi.md#get_artist_by_name) | **GET** /Artists/{name} | Gets an artist by name.
[**get_artists**](ArtistApi.md#get_artists) | **GET** /Artists | Gets all artists from a given item, folder, or the entire library.
...
**exclude_item_types** | Option<[**Vec<models::BaseItemKind>**](Models__BaseItemKind.md)> | Optional. If specified, results will be filtered out based on item type. This allows multiple, comma delimited. |  |
...
**person_ids** | Option<[**Vec<uuid::Uuid>**](Uuid__Uuid.md)> | Optional. If specified, results will be filtered to include only those containing the specified person ids. |  |
...
**sort_by** | Option<[**Vec<models::ItemSortBy>**](Models__ItemSortBy.md)> | Optional. Specify one or more sort orders, comma delimited. |  |
