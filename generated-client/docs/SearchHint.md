...
**r#type** | Option<[**models::BaseItemKind**](BaseItemKind.md)> | The base item kind. | [optional]
...
**media_type** | Option<[**models::MediaType**](MediaType.md)> | Media types. | [optional][default to Unknown]
