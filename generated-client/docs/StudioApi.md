...
------------- | ------------- | -------------
[**get_studio**](StudioApi.md#get_studio) | **GET** /Studios/{name} | Gets a studio by name.
[**get_studios**](StudioApi.md#get_studios) | **GET** /Studios | Gets all studios from a given item, folder, or the entire library.
