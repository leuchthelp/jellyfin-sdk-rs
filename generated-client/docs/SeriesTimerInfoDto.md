...
**channel_id** | Option<**uuid::Uuid**> | Gets or sets the channel id of the recording. | [optional]
...
**start_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Gets or sets the start date of the recording, in UTC. | [optional]
**end_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Gets or sets the end date of the recording, in UTC. | [optional]
...
**day_pattern** | Option<[**models::DayPattern**](DayPattern.md)> | Gets or sets the day pattern. | [optional]
...
**parent_primary_image_item_id** | Option<**uuid::Uuid**> | Gets or sets the parent primary image item identifier. | [optional]
