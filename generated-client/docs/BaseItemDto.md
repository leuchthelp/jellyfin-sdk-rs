...
**date_last_media_added** | Option<**chrono::DateTime<chrono::FixedOffset>**> |  | [optional]
**extra_type** | Option<[**models::ExtraType**](ExtraType.md)> |  | [optional]
...
**has_lyrics** | Option<**bool**> |  | [optional]
...
**video3_d_format** | Option<[**models::Video3DFormat**](Video3DFormat.md)> | Gets or sets the video3 D format. | [optional]
**premiere_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Gets or sets the premiere date. | [optional]
...
**play_access** | Option<[**models::PlayAccess**](PlayAccess.md)> | Gets or sets the play access. | [optional]
...
**parent_id** | Option<**uuid::Uuid**> | Gets or sets the parent id. | [optional]
...
**parent_logo_item_id** | Option<**uuid::Uuid**> | Gets or sets whether the item has a logo, this will hold the Id of the Parent that has one. | [optional]
**parent_backdrop_item_id** | Option<**uuid::Uuid**> | Gets or sets whether the item has any backdrops, this will hold the Id of the Parent that has one. | [optional]
...
**user_data** | Option<[**models::UserItemDataDto**](UserItemDataDto.md)> | Gets or sets the user data for this item based on the user it's being requested for. | [optional]
...
**series_id** | Option<**uuid::Uuid**> | Gets or sets the series id. | [optional]
**season_id** | Option<**uuid::Uuid**> | Gets or sets the season identifier. | [optional]
...
**collection_type** | Option<[**models::CollectionType**](CollectionType.md)> | Gets or sets the type of the collection. | [optional]
...
**video_type** | Option<[**models::VideoType**](VideoType.md)> | Gets or sets the type of the video. | [optional]
...
**parent_art_item_id** | Option<**uuid::Uuid**> | Gets or sets whether the item has fan art, this will hold the Id of the Parent that has one. | [optional]
...
**parent_thumb_item_id** | Option<**uuid::Uuid**> | Gets or sets the parent thumb item id. | [optional]
...
**trickplay** | Option<**std::collections::HashMap<String, std::collections::HashMap<String, models::TrickplayInfoDto>>**> | Gets or sets the trickplay manifest. | [optional]
**location_type** | Option<[**models::LocationType**](LocationType.md)> | Gets or sets the type of the location. | [optional]
**iso_type** | Option<[**models::IsoType**](IsoType.md)> | Gets or sets the type of the iso. | [optional]
...
**channel_type** | Option<[**models::ChannelType**](ChannelType.md)> | Gets or sets the type of the channel. | [optional]
**audio** | Option<[**models::ProgramAudio**](ProgramAudio.md)> | Gets or sets the audio. | [optional]
...
**normalization_gain** | Option<**f32**> | Gets or sets the gain required for audio normalization. | [optional]
**album_normalization_gain** | Option<**f32**> | Gets or sets the gain required for audio normalization. This field is inherited from music album normalization gain. | [optional]
**current_program** | Option<[**models::BaseItemDto**](BaseItemDto.md)> | Gets or sets the current program. | [optional]
