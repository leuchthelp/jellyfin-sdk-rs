...
------------ | ------------- | ------------- | -------------
**item_ids** | Option<**Vec<uuid::Uuid>**> | Gets or sets the item ids. | [optional]
**start_position_ticks** | Option<**i64**> | Gets or sets the start position ticks that the first item should be played at. | [optional]
**play_command** | Option<[**models::PlayCommand**](PlayCommand.md)> | Gets or sets the play command. | [optional]
**controlling_user_id** | Option<**uuid::Uuid**> | Gets or sets the controlling user identifier. | [optional]
