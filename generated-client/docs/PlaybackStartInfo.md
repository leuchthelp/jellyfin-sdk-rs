...
**item** | Option<[**models::BaseItemDto**](BaseItemDto.md)> | Gets or sets the item. | [optional]
**item_id** | Option<**uuid::Uuid**> | Gets or sets the item identifier. | [optional]
...
**play_method** | Option<[**models::PlayMethod**](PlayMethod.md)> | Gets or sets the play method. | [optional]
...
**repeat_mode** | Option<[**models::RepeatMode**](RepeatMode.md)> | Gets or sets the repeat mode. | [optional]
**playback_order** | Option<[**models::PlaybackOrder**](PlaybackOrder.md)> | Gets or sets the playback order. | [optional]
