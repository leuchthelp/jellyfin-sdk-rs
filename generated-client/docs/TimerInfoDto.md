...
**status** | Option<[**models::RecordingStatus**](RecordingStatus.md)> | Gets or sets the status. | [optional]
...
**program_info** | Option<[**models::BaseItemDto**](BaseItemDto.md)> | Gets or sets the program information. | [optional]
