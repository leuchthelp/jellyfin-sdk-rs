...
[**ping_playback_session**](SessionApi.md#ping_playback_session) | **POST** /Sessions/Playing/Ping | Pings a playback session.
...
[**report_playback_progress**](SessionApi.md#report_playback_progress) | **POST** /Sessions/Playing/Progress | Reports playback progress within a session.
[**report_playback_start**](SessionApi.md#report_playback_start) | **POST** /Sessions/Playing | Reports playback has started within a session.
[**report_playback_stopped**](SessionApi.md#report_playback_stopped) | **POST** /Sessions/Playing/Stopped | Reports playback has stopped within a session.
...
------------- | ------------- | ------------- | ------------- | -------------
**session_id** | **String** | The session Id. | [required] |
**item_type** | **models::BaseItemKind** | The type of item to browse to. | [required] |
...
> Vec<models::SessionInfoDto> get_sessions(controllable_by_user_id, device_id, active_within_seconds)
...
[**Vec<models::SessionInfoDto>**](SessionInfoDto.md)
...
------------- | ------------- | ------------- | ------------- | -------------
**session_id** | **String** | The session id. | [required] |
**play_command** | **models::PlayCommand** | The type of play command to issue (PlayNow, PlayNext, PlayLast). Clients who have not yet implemented play next and play last may play now. | [required] |
**item_ids** | [**Vec<uuid::Uuid>**](Uuid__Uuid.md) | The ids of the items to play, comma delimited. | [required] |
...
> post_capabilities(id, playable_media_types, supported_commands, supports_media_control, supports_persistent_identifier)
...
**playable_media_types** | Option<[**Vec<models::MediaType>**](Models__MediaType.md)> | A list of playable media types, comma delimited. Audio, Video, Book, Photo. |  |
**supported_commands** | Option<[**Vec<models::GeneralCommandType>**](Models__GeneralCommandType.md)> | A list of supported remote control commands, comma delimited. |  |
...
------------- | ------------- | ------------- | ------------- | -------------
**session_id** | **String** | The session id. | [required] |
**command** | **models::GeneralCommandType** | The command to send. | [required] |
...
------------- | ------------- | ------------- | ------------- | -------------
**session_id** | **String** | The session id. | [required] |
**command** | **models::PlaystateCommand** | The MediaBrowser.Model.Session.PlaystateCommand. | [required] |
