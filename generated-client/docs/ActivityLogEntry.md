...
**date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Gets or sets the date. | [optional]
**user_id** | Option<**uuid::Uuid**> | Gets or sets the user identifier. | [optional]
**user_primary_image_tag** | Option<**String**> | Gets or sets the user primary image tag. | [optional]
**severity** | Option<[**models::LogLevel**](LogLevel.md)> | Gets or sets the log severity. | [optional]
