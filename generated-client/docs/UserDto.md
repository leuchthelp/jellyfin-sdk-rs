...
**id** | Option<**uuid::Uuid**> | Gets or sets the id. | [optional]
...
**last_login_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Gets or sets the last login date. | [optional]
**last_activity_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Gets or sets the last activity date. | [optional]
**configuration** | Option<[**models::UserConfiguration**](UserConfiguration.md)> | Gets or sets the configuration. | [optional]
**policy** | Option<[**models::UserPolicy**](UserPolicy.md)> | Gets or sets the policy. | [optional]
