...
**image_type** | **models::ImageType** | Image type. | [required] |
...
> std::path::PathBuf get_artist_image(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
...
**format** | Option<**models::ImageFormat**> | Determines the output format of the image - original,gif,jpg,png. |  |
...
> std::path::PathBuf get_genre_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
...
> std::path::PathBuf get_genre_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get genre image by name.
...
> std::path::PathBuf get_item_image(item_id, image_type, max_width, max_height, width, height, quality, fill_width, fill_height, tag, format, percent_played, unplayed_count, blur, background_color, foreground_layer, image_index)
...
**fill_height** | Option<**i32**> | Height of box to fill. |  |
**tag** | Option<**String**> | Optional. Supply the cache tag from the item object to receive strong caching headers. |  |
**format** | Option<**models::ImageFormat**> | Optional. The MediaBrowser.Model.Drawing.ImageFormat of the returned image. |  |
**percent_played** | Option<**f64**> | Optional. Percent to render for the percent played overlay. |  |
**unplayed_count** | Option<**i32**> | Optional. Unplayed count overlay to render. |  |
**blur** | Option<**i32**> | Optional. Blur image. |  |
**background_color** | Option<**String**> | Optional. Apply a background color for transparent images. |  |
...
> std::path::PathBuf get_item_image2(item_id, image_type, max_width, max_height, tag, format, percent_played, unplayed_count, image_index, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Gets the item's image.
...
**format** | **models::ImageFormat** | Determines the output format of the image - original,gif,jpg,png. | [required] |
...
> std::path::PathBuf get_item_image_by_index(item_id, image_type, image_index, max_width, max_height, width, height, quality, fill_width, fill_height, tag, format, percent_played, unplayed_count, blur, background_color, foreground_layer)
Gets the item's image.
...
> std::path::PathBuf get_music_genre_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
...
> std::path::PathBuf get_music_genre_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get music genre image by name.
...
> std::path::PathBuf get_person_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
...
> std::path::PathBuf get_person_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get person image by name.
...
> std::path::PathBuf get_splashscreen(tag, format)
...
> std::path::PathBuf get_studio_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
...
> std::path::PathBuf get_studio_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get studio image by name.
...
> std::path::PathBuf get_user_image(user_id, tag, format)
...
> std::path::PathBuf head_artist_image(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get artist image by name.
...
> std::path::PathBuf head_genre_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
Get genre image by name.
...
> std::path::PathBuf head_genre_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get genre image by name.
...
> std::path::PathBuf head_item_image(item_id, image_type, max_width, max_height, width, height, quality, fill_width, fill_height, tag, format, percent_played, unplayed_count, blur, background_color, foreground_layer, image_index)
Gets the item's image.
...
> std::path::PathBuf head_item_image2(item_id, image_type, max_width, max_height, tag, format, percent_played, unplayed_count, image_index, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Gets the item's image.
...
> std::path::PathBuf head_item_image_by_index(item_id, image_type, image_index, max_width, max_height, width, height, quality, fill_width, fill_height, tag, format, percent_played, unplayed_count, blur, background_color, foreground_layer)
Gets the item's image.
...
> std::path::PathBuf head_music_genre_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
Get music genre image by name.
...
> std::path::PathBuf head_music_genre_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get music genre image by name.
...
> std::path::PathBuf head_person_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
Get person image by name.
...
> std::path::PathBuf head_person_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get person image by name.
...
> std::path::PathBuf head_studio_image(name, image_type, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer, image_index)
Get studio image by name.
...
> std::path::PathBuf head_studio_image_by_index(name, image_type, image_index, tag, format, max_width, max_height, percent_played, unplayed_count, width, height, quality, fill_width, fill_height, blur, background_color, foreground_layer)
Get studio image by name.
...
> std::path::PathBuf head_user_image(user_id, tag, format)
Get user profile image.
