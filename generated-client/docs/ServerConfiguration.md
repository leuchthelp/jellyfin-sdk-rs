...
**inactive_session_threshold** | Option<**i32**> | Gets or sets the threshold in minutes after a inactive session gets closed automatically. If set to 0 the check for inactive sessions gets disabled. | [optional]
...
**library_update_duration** | Option<**i32**> | Gets or sets the duration in seconds that we will wait after a library updated event before executing the library changed notification. | [optional]
**cache_size** | Option<**i32**> | Gets or sets the maximum amount of items to cache. | [optional]
**image_saving_convention** | Option<[**models::ImageSavingConvention**](ImageSavingConvention.md)> | Gets or sets the image saving convention. | [optional]
...
**enable_grouping_movies_into_collections** | Option<**bool**> |  | [optional]
**enable_grouping_shows_into_collections** | Option<**bool**> |  | [optional]
...
**dummy_chapter_duration** | Option<**i32**> | Gets or sets the dummy chapter duration in seconds, use 0 (zero) or less to disable generation altogether. | [optional]
**chapter_image_resolution** | Option<[**models::ImageResolution**](ImageResolution.md)> | Gets or sets the chapter image resolution. | [optional]
**parallel_image_encoding_limit** | Option<**i32**> | Gets or sets the limit for parallel image encoding. | [optional]
...
**trickplay_options** | Option<[**models::TrickplayOptions**](TrickplayOptions.md)> | Gets or sets the trickplay options. | [optional]
**enable_legacy_authorization** | Option<**bool**> | Gets or sets a value indicating whether old authorization methods are allowed. | [optional]
