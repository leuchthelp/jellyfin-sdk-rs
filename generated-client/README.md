# Rust API client for jellyfin-generated-client
...
Put the package under your project folder in a directory named `jellyfin-generated-client` and add the following to `Cargo.toml` under `[dependencies]`:

```
jellyfin-generated-client = { path = "./jellyfin-generated-client" }
```
