...
use crate::{
    client::constants::{ACCEPT_LANGUAGE_HEADER, AUTHORIZATION_HEADER},
    models::{ClientInfo, DeviceInfo},
...
impl ConfigureClient for JellyfinClient {
    fn configure(
        base_url: Url,
        client_info: ClientInfo,
        device_info: DeviceInfo,
        ...
        let auth_header =
            get_authorization_header(client_info, &device_info, access_token).unwrap();
